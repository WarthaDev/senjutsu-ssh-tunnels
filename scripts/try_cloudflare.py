...
if cmd_opts.cloudflared:
    ...
    strings.en["SHARE_LINK_MESSAGE"] = f"Public WarthaDev URL: {tunnel_url.tunnel}"
    strings.en["PUBLIC_SHARE_TRUE"] = f"Public WarthaDev Colab URL: {tunnel_url.tunnel}"
...
if cmd_opts.multiple:
    ...
    colab_url = os.getenv('colab_url')
    strings.en["SHARE_LINK_MESSAGE"] = f"Public WarthaDev URL: {tunnel_url.tunnel}"
    strings.en["PUBLIC_SHARE_TRUE"] = f"Public WarthaDev URL: {tunnel_url.tunnel}"
